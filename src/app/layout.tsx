...
export const metadata: Metadata = {
  title: "Mykola Chuchuka & Vitaliy SuperKot - CS:GO Legends",  description: "Witness the mastery of two Counter-Strike pro players. Explore stats, tournament highlights, and dominating gameplay from Mykola and Vitaliy.",  keywords: "counter-strike, esports, competitive gaming, Mykola Chuchuka, Vitaliy SuperKot, CS:GO",  metadataBase: new URL("https://csgolegens.com"),
  alternates: {
    canonical: "https://csgolegens.com"
  },
  openGraph: {
    title: "Mykola Chuchuka & Vitaliy SuperKot - CS:GO Legends",    description: "Two Counter-Strike icons dominating competitive play. Experience raw skill and championship moments.",    url: "https://csgolegens.com",    siteName: "CSGO Legends",    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "CSGO Legends - Mykola & Vitaliy",    description: "Professional Counter-Strike players showcasing world-class gameplay."
  },
  robots: {
    index: true,
    follow: true
